...
export default function AdminDashboardOverview({ setActiveTab }) {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      <Card
        className="relative overflow-hidden xl:col-span-2 rounded-3xl border border-slate-200 bg-white p-6 text-slate-900 shadow-[0_10px_25px_rgba(0,0,0,0.08)] dark:border-cyan-400/20 dark:bg-[linear-gradient(180deg,#071c2c_0%,#0a2236_100%)] 
      ...
      <div className="space-y-6">
        <Card
          className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 text-slate-900 shadow-[0_10px_25px_rgba(0,0,0,0.08)] dark:border-cyan-400/20 dark:bg-[linear-gradient(180deg,#071c2c_0%,#0a2236_100%)] 
          dark:text-white dark:shadow-[0_10px_25px_rgba(0,0,0,0.20)] transition-colors"
        >
          {" "}
